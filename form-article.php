    ...
    <div class="container">
        ...
        <div class="content">
            <div class="block p-20 form-container">
                <h1><?= $id ? 'Editer' : 'Créer'  ?> un article</h1>
                <form action="/form-article.php<?= $id ? "?id=$id" : '' ?>" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <select name="category" id="category">
                            <option
                                <?= !$category || $category === 'technologie' ? 'selected' : '' ?>value="technologie">
                                Technologie</option>
                            <option <?= $category === 'nature' ? 'selected' : '' ?> value="nature">Nature</option>
                            <option <?= $category === 'politique' ? 'selected' : '' ?> value="politique">Politique
                            </option>
                    ...
                    <div class="form-action">
                        ...
                        <button class="btn btn-primary" type="submit"><?= $id ? 'Modifer' : 'Sauvegarder' ?></button>
